...
class ContactsBase extends Resource
{
    ...
    public function list(?array $query = null, ?RequestOptions $options = null): Page
    {
        return $this->paginate(
            Contact::class,
            fn (?string $cursor): ContactList => $this->single('GET', '/v1/contacts', ContactList::class, null, $cursor === null ? ($query ?? []) : array_merge(array_diff_key($query ?? [], ['ending_before' => true]), ['starting_after' => $cursor]), $options),
