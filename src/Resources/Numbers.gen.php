...
class NumbersBase extends Resource
{
    ...
    public function list(?array $query = null, ?RequestOptions $options = null): Page
    {
        return $this->paginate(
            Number::class,
            fn (?string $cursor): NumberList => $this->single('GET', '/v1/numbers', NumberList::class, null, $cursor === null ? ($query ?? []) : array_merge(array_diff_key($query ?? [], ['ending_before' => true]), ['starting_after' => $cursor]), $options),
