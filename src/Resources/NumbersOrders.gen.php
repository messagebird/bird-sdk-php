...
final class NumbersOrders extends Resource
{
    ...
    public function list(?array $query = null, ?RequestOptions $options = null): Page
    {
        return $this->paginate(
            NumbersOrder::class,
            fn (?string $cursor): NumbersOrderList => $this->single('GET', '/v1/numbers/orders', NumbersOrderList::class, null, $cursor === null ? ($query ?? []) : array_merge(array_diff_key($query ?? [], ['ending_before' => true]), ['starting_after' => $cursor]), $options),
