...
class WhatsAppStatsByPhoneNumberResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<WhatsAppPhoneNumberStatsPoint>|null
     */
    protected $data;
    /**
     ...
     * Phone-number rows ranked by accepted volume descending.
     *
     * @return list<WhatsAppPhoneNumberStatsPoint>|null
     */
     ...
     * Phone-number rows ranked by accepted volume descending.
     *
     * @param list<WhatsAppPhoneNumberStatsPoint>|null $data
     *
     * @return self
     */
