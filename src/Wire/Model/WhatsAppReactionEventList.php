...
class WhatsAppReactionEventList extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<WhatsAppReactionEvent>|null
     */
    protected $data;
    /**
     ...
     * Changes to this message's reactions, newest first.
     *
     * @return list<WhatsAppReactionEvent>|null
     */
     ...
     * Changes to this message's reactions, newest first.
     *
     * @param list<WhatsAppReactionEvent>|null $data
     *
     * @return self
     */
