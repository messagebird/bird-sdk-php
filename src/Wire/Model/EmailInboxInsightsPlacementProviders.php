...
class EmailInboxInsightsPlacementProviders
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EmailInboxInsightsPlacementProvider>|null
     */
    protected $items;
    /**
     ...
     * One row per mailbox provider the measurement observed for this domain in the period.
     *
     * @return list<EmailInboxInsightsPlacementProvider>|null
     */
     ...
     * One row per mailbox provider the measurement observed for this domain in the period.
     *
     * @param list<EmailInboxInsightsPlacementProvider>|null $items
     *
     * @return self
     */
