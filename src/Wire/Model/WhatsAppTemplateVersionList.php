...
class WhatsAppTemplateVersionList extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<WhatsAppTemplateVersionSummary>|null
     */
    protected $data;
    /**
     ...
     * Page of the template's versions, newest first.
     *
     * @return list<WhatsAppTemplateVersionSummary>|null
     */
     ...
     * Page of the template's versions, newest first.
     *
     * @param list<WhatsAppTemplateVersionSummary>|null $data
     *
     * @return self
     */
