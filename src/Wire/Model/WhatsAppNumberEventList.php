...
class WhatsAppNumberEventList extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<WhatsAppNumberEvent>|null
     */
    protected $data;
    /**
     ...
     * Page of number events, newest first by default.
     *
     * @return list<WhatsAppNumberEvent>|null
     */
     ...
     * Page of number events, newest first by default.
     *
     * @param list<WhatsAppNumberEvent>|null $data
     *
     * @return self
     */
