...
class EmailInboxInsightsDomains extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @var list<EmailInboxInsightsDomain>|null
     */
    protected $data;
    /**
     ...
     * 
     *
     * @return list<EmailInboxInsightsDomain>|null
     */
     ...
     * One entry per verified domain in this page, whether or not it is switched on. A domain that has not been verified does not appear, because verification is what proves the domain is yours to report on.
     *
     * @param list<EmailInboxInsightsDomain>|null $data
     *
     * @return self
     */
