...
class EmailTemplateVersionList extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @var list<EmailTemplateVersionSummary>|null
     */
    protected $data;
    /**
     ...
     * 
     *
     * @return list<EmailTemplateVersionSummary>|null
     */
     ...
     * One page of the template's versions, newest first. Each entry describes a version and which languages it holds. Read a single version if you want its actual content.
     *
     * @param list<EmailTemplateVersionSummary>|null $data
     *
     * @return self
     */
