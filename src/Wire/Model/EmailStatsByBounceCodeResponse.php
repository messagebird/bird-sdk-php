...
class EmailStatsByBounceCodeResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EmailBounceCodeStatsPoint>|null
     */
    protected $data;
    /**
     ...
     * Bounce-code breakdown rows, ranked by the `sort` metric (default `bounced`) descending. Empty when no bounces occurred in the period.
     *
     * @return list<EmailBounceCodeStatsPoint>|null
     */
     ...
     * Bounce-code breakdown rows, ranked by the `sort` metric (default `bounced`) descending. Empty when no bounces occurred in the period.
     *
     * @param list<EmailBounceCodeStatsPoint>|null $data
     *
     * @return self
     */
