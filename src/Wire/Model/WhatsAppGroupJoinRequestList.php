...
class WhatsAppGroupJoinRequestList extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<WhatsAppGroupJoinRequest>|null
     */
    protected $data;
    /**
     ...
     * The join requests still waiting for a decision, oldest first.
     *
     * @return list<WhatsAppGroupJoinRequest>|null
     */
     ...
     * The join requests still waiting for a decision, oldest first.
     *
     * @param list<WhatsAppGroupJoinRequest>|null $data
     *
     * @return self
     */
