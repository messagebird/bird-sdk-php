...
class EmailStatsByCategoryResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EmailCategoryStatsPoint>|null
     */
    protected $data;
    /**
     ...
     * Category breakdown rows, ranked by the `sort` metric (default `processed`) descending. Empty when no sends occurred in the period.
     *
     * @return list<EmailCategoryStatsPoint>|null
     */
     ...
     * Category breakdown rows, ranked by the `sort` metric (default `processed`) descending. Empty when no sends occurred in the period.
     *
     * @param list<EmailCategoryStatsPoint>|null $data
     *
     * @return self
     */
