...
class WhatsAppBusinessAccountList extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<WhatsAppBusinessAccount>|null
     */
    protected $data;
    /**
     ...
     * The WhatsApp Business Accounts your workspace has connected.
     *
     * @return list<WhatsAppBusinessAccount>|null
     */
     ...
     * The WhatsApp Business Accounts your workspace has connected.
     *
     * @param list<WhatsAppBusinessAccount>|null $data
     *
     * @return self
     */
