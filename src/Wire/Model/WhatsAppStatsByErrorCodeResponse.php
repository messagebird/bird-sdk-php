...
class WhatsAppStatsByErrorCodeResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<WhatsAppErrorCodeStatsPoint>|null
     */
    protected $data;
    /**
     ...
     * Error-code rows ranked by failure count descending. Empty when no failures occurred in the period.
     *
     * @return list<WhatsAppErrorCodeStatsPoint>|null
     */
     ...
     * Error-code rows ranked by failure count descending. Empty when no failures occurred in the period.
     *
     * @param list<WhatsAppErrorCodeStatsPoint>|null $data
     *
     * @return self
     */
