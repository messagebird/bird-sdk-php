...
class EmailStatsBySendingIpResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EmailSendingIpStatsPoint>|null
     */
    protected $data;
    /**
     ...
     * Sending-IP breakdown rows, ranked by the `sort` metric (default `delivered`) descending. Empty when no per-IP-attributable activity (delivery, bounce, deferral, or late bounce) occurred in the period.
     *
     * @return list<EmailSendingIpStatsPoint>|null
     */
     ...
     * Sending-IP breakdown rows, ranked by the `sort` metric (default `delivered`) descending. Empty when no per-IP-attributable activity (delivery, bounce, deferral, or late bounce) occurred in the period.
     *
     * @param list<EmailSendingIpStatsPoint>|null $data
     *
     * @return self
     */
