...
class EmailStatsByMailboxProviderRegionResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EmailMailboxProviderRegionStatsPoint>|null
     */
    protected $data;
    /**
     ...
     * Provider-region breakdown rows, ranked by the `sort` metric (default `delivered`) descending. Empty when no deliveries occurred in the period.
     *
     * @return list<EmailMailboxProviderRegionStatsPoint>|null
     */
     ...
     * Provider-region breakdown rows, ranked by the `sort` metric (default `delivered`) descending. Empty when no deliveries occurred in the period.
     *
     * @param list<EmailMailboxProviderRegionStatsPoint>|null $data
     *
     * @return self
     */
