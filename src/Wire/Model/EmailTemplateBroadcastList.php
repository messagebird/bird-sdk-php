...
class EmailTemplateBroadcastList extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EmailTemplateBroadcastSummary>|null
     */
    protected $data;
    /**
     ...
     * Page of broadcasts blocking a delete of the template, newest first.
     *
     * @return list<EmailTemplateBroadcastSummary>|null
     */
     ...
     * Page of broadcasts blocking a delete of the template, newest first.
     *
     * @param list<EmailTemplateBroadcastSummary>|null $data
     *
     * @return self
     */
