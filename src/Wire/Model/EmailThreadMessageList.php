...
class EmailThreadMessageList extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    /**
     * @var list<EmailThreadMessage>|null
     */
    protected $data;
    /**
    ...
    /**
     * @return list<EmailThreadMessage>|null
     */
    ...
    /**
     * @param list<EmailThreadMessage>|null $data
     *
     * @return self
     */
