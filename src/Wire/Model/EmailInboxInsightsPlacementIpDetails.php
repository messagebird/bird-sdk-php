...
class EmailInboxInsightsPlacementIpDetails
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EmailInboxInsightsPlacementIpDetail>|null
     */
    protected $items;
    /**
     ...
     * One row per sending IP the measurement observed for this domain in the period.
     *
     * @return list<EmailInboxInsightsPlacementIpDetail>|null
     */
     ...
     * One row per sending IP the measurement observed for this domain in the period.
     *
     * @param list<EmailInboxInsightsPlacementIpDetail>|null $items
     *
     * @return self
     */
