...
class EmailStatsByLocationResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EmailLocationStatsPoint>|null
     */
    protected $data;
    /**
     ...
     * Location breakdown rows, ranked by the `sort` metric (default `unique_opens`) descending. Empty when no opens or clicks with a resolved location occurred in the period.
     *
     * @return list<EmailLocationStatsPoint>|null
     */
     ...
     * Location breakdown rows, ranked by the `sort` metric (default `unique_opens`) descending. Empty when no opens or clicks with a resolved location occurred in the period.
     *
     * @param list<EmailLocationStatsPoint>|null $data
     *
     * @return self
     */
