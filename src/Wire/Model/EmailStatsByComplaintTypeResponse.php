...
class EmailStatsByComplaintTypeResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EmailComplaintTypeStatsPoint>|null
     */
    protected $data;
    /**
     ...
     * Complaint-type breakdown rows, ranked by `complained` descending. Empty when no complaints occurred in the period.
     *
     * @return list<EmailComplaintTypeStatsPoint>|null
     */
     ...
     * Complaint-type breakdown rows, ranked by `complained` descending. Empty when no complaints occurred in the period.
     *
     * @param list<EmailComplaintTypeStatsPoint>|null $data
     *
     * @return self
     */
