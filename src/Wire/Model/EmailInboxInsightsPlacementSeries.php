...
class EmailInboxInsightsPlacementSeries
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @var list<EmailInboxInsightsPlacementSeriesPoint>|null
     */
    protected $items;
    /**
     ...
     * 
     *
     * @return list<EmailInboxInsightsPlacementSeriesPoint>|null
     */
     ...
     * One point per bucket with measured placements. With providers named in the request, one point per bucket per provider.
     *
     * @param list<EmailInboxInsightsPlacementSeriesPoint>|null $items
     *
     * @return self
     */
