...
class SMSTemplateVersionList extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<SMSTemplateVersionSummary>|null
     */
    protected $data;
    /**
     ...
     * One page of the template's versions, newest first.
     *
     * @return list<SMSTemplateVersionSummary>|null
     */
     ...
     * One page of the template's versions, newest first.
     *
     * @param list<SMSTemplateVersionSummary>|null $data
     *
     * @return self
     */
