...
class EmailTemplateSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\EmailTemplateSummary::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\EmailTemplateSummary::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\EmailTemplateSummary();
        ...
        elseif (\array_key_exists('theme', $data) && $data['theme'] === null) {
        ...
        if (\array_key_exists('live_version_number', $data) && $data['live_version_number'] !== null) {
            $object->setLiveVersionNumber($data['live_version_number']);
        }
        elseif (\array_key_exists('live_version_number', $data) && $data['live_version_number'] === null) {
            $object->setLiveVersionNumber(null);
        }
        ...
        if (\array_key_exists('languages', $data) && $data['languages'] !== null) {
            ...
            foreach ($data['languages'] as $key => $value_1) {
                $values_1[$key] = $this->denormalizer->denormalize($value_1, \MessageBird\Wire\Model\EmailTemplateLanguageState::class, 'json', $context);
            }
    ...
    {
        return [\MessageBird\Wire\Model\EmailTemplateSummary::class => false];
    }
}
