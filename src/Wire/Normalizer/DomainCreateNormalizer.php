...
class DomainCreateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\DomainCreate::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\DomainCreate::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\DomainCreate();
        ...
        if (\array_key_exists('tracking', $data) && $data['tracking'] !== null) {
            $object->setTracking($this->denormalizer->denormalize($data['tracking'], \MessageBird\Wire\Model\DomainTrackingConfig::class, 'json', $context));
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('tracking') && null !== $data->getTracking()) {
    ...
    {
        return [\MessageBird\Wire\Model\DomainCreate::class => false];
    }
}
