...
class WhatsAppPhoneNumberStatsPointDeliveryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\WhatsAppPhoneNumberStatsPointDelivery::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\WhatsAppPhoneNumberStatsPointDelivery::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\WhatsAppPhoneNumberStatsPointDelivery();
    ...
    {
        return [\MessageBird\Wire\Model\WhatsAppPhoneNumberStatsPointDelivery::class => false];
    }
}
