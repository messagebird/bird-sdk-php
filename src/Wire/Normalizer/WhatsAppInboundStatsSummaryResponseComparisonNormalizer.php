...
class WhatsAppInboundStatsSummaryResponseComparisonNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\WhatsAppInboundStatsSummaryResponseComparison::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\WhatsAppInboundStatsSummaryResponseComparison::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\WhatsAppInboundStatsSummaryResponseComparison();
    ...
    {
        return [\MessageBird\Wire\Model\WhatsAppInboundStatsSummaryResponseComparison::class => false];
    }
}
