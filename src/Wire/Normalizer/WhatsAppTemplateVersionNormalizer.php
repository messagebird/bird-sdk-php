...
class WhatsAppTemplateVersionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\WhatsAppTemplateVersion::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\WhatsAppTemplateVersion::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\WhatsAppTemplateVersion();
        ...
        if (\array_key_exists('languages', $data) && $data['languages'] !== null) {
            ...
            foreach ($data['languages'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, \MessageBird\Wire\Model\WhatsAppTemplateVersionLanguage::class, 'json', $context);
            }
    ...
    {
        return [\MessageBird\Wire\Model\WhatsAppTemplateVersion::class => false];
    }
}
