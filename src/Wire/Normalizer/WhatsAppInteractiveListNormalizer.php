...
class WhatsAppInteractiveListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\WhatsAppInteractiveList::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\WhatsAppInteractiveList::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\WhatsAppInteractiveList();
        ...
        if (\array_key_exists('sections', $data) && $data['sections'] !== null) {
            $values = [];
    ...
    {
        $dataArray = [];
        $dataArray['button_text'] = $data->getButtonText();
        $values = [];
    ...
    {
        return [\MessageBird\Wire\Model\WhatsAppInteractiveList::class => false];
    }
}
