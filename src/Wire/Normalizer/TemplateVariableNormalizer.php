...
class TemplateVariableNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\TemplateVariable::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\TemplateVariable::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\TemplateVariable();
        ...
        if (\array_key_exists('constraint', $data) && $data['constraint'] !== null) {
            $object->setConstraint($data['constraint']);
        }
        elseif (\array_key_exists('constraint', $data) && $data['constraint'] === null) {
    ...
    {
        return [\MessageBird\Wire\Model\TemplateVariable::class => false];
    }
}
