...
class EmailInboxInsightsAuthenticationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\EmailInboxInsightsAuthentication::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\EmailInboxInsightsAuthentication::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\EmailInboxInsightsAuthentication();
        ...
        if (\array_key_exists('spf', $data) && $data['spf'] !== null) {
            $object->setSpf($this->denormalizer->denormalize($data['spf'], \MessageBird\Wire\Model\EmailInboxInsightsAuthPassRate::class, 'json', $context));
            unset($data['spf']);
        }
        elseif (\array_key_exists('spf', $data) && $data['spf'] === null) {
            $object->setSpf(null);
        }
        if (\array_key_exists('dkim', $data) && $data['dkim'] !== null) {
            $object->setDkim($this->denormalizer->denormalize($data['dkim'], \MessageBird\Wire\Model\EmailInboxInsightsAuthPassRate::class, 'json', $context));
            unset($data['dkim']);
        }
        ...
        if (\array_key_exists('dmarc', $data) && $data['dmarc'] !== null) {
            $object->setDmarc($this->denormalizer->denormalize($data['dmarc'], \MessageBird\Wire\Model\EmailInboxInsightsDmarc::class, 'json', $context));
            unset($data['dmarc']);
        }
        ...
        if (\array_key_exists('sources', $data) && $data['sources'] !== null) {
            $object->setSources($this->denormalizer->denormalize($data['sources'], \MessageBird\Wire\Model\EmailInboxInsightsAuthSources::class, 'json', $context));
            unset($data['sources']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['spf'] = $this->normalizer->normalize($data->getSpf(), 'json', $context);
    ...
    {
        return [\MessageBird\Wire\Model\EmailInboxInsightsAuthentication::class => false];
    }
}
