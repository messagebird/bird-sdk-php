...
class EmailTemplateVersionSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\EmailTemplateVersionSummary::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\EmailTemplateVersionSummary::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\EmailTemplateVersionSummary();
        ...
        if (\array_key_exists('updated_by', $data) && $data['updated_by'] !== null) {
            $object->setUpdatedBy($this->denormalizer->denormalize($data['updated_by'], \MessageBird\Wire\Model\EmailTemplateVersionSummaryUpdatedBy::class, 'json', $context));
        }
    ...
    {
        return [\MessageBird\Wire\Model\EmailTemplateVersionSummary::class => false];
    }
}
