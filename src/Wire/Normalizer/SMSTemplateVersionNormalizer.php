...
class SMSTemplateVersionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\SMSTemplateVersion::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\SMSTemplateVersion::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\SMSTemplateVersion();
        ...
        if (\array_key_exists('languages', $data) && $data['languages'] !== null) {
            ...
            foreach ($data['languages'] as $key => $value_1) {
                $values_1[$key] = $this->denormalizer->denormalize($value_1, \MessageBird\Wire\Model\SMSTemplateVersionLanguage::class, 'json', $context);
            }
    ...
    {
        return [\MessageBird\Wire\Model\SMSTemplateVersion::class => false];
    }
}
