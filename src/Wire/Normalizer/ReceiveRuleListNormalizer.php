...
class ReceiveRuleListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\ReceiveRuleList::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\ReceiveRuleList::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\ReceiveRuleList();
        ...
        if (\array_key_exists('data', $data) && $data['data'] !== null) {
            ...
            foreach ($data['data'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \MessageBird\Wire\Model\ReceiveRule::class, 'json', $context);
            }
    ...
    {
        return [\MessageBird\Wire\Model\ReceiveRuleList::class => false];
    }
}
