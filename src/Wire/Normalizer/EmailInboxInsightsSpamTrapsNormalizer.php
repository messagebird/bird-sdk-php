...
class EmailInboxInsightsSpamTrapsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\EmailInboxInsightsSpamTraps::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\EmailInboxInsightsSpamTraps::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\EmailInboxInsightsSpamTraps();
        ...
        if (\array_key_exists('delta', $data) && $data['delta'] !== null) {
            $object->setDelta($data['delta']);
            unset($data['delta']);
        }
        elseif (\array_key_exists('delta', $data) && $data['delta'] === null) {
            $object->setDelta(null);
        }
        if (\array_key_exists('by_type', $data) && $data['by_type'] !== null) {
            $values = [];
            foreach ($data['by_type'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \MessageBird\Wire\Model\EmailInboxInsightsSpamTrapTypeCount::class, 'json', $context);
            }
            $object->setByType($values);
            unset($data['by_type']);
        }
        elseif (\array_key_exists('by_type', $data) && $data['by_type'] === null) {
            $object->setByType(null);
        }
        if (\array_key_exists('by_source', $data) && $data['by_source'] !== null) {
            $values_1 = [];
            foreach ($data['by_source'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \MessageBird\Wire\Model\EmailInboxInsightsSpamTrapSourceCount::class, 'json', $context);
            }
            $object->setBySource($values_1);
            unset($data['by_source']);
        }
        elseif (\array_key_exists('by_source', $data) && $data['by_source'] === null) {
            $object->setBySource(null);
        }
        if (\array_key_exists('hit_rows', $data) && $data['hit_rows'] !== null) {
            $object->setHitRows($this->denormalizer->denormalize($data['hit_rows'], \MessageBird\Wire\Model\EmailInboxInsightsSpamTrapHits::class, 'json', $context));
            unset($data['hit_rows']);
        }
        elseif (\array_key_exists('hit_rows', $data) && $data['hit_rows'] === null) {
            $object->setHitRows(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['hit_rows'] = $this->normalizer->normalize($data->getHitRows(), 'json', $context);
    ...
    {
        return [\MessageBird\Wire\Model\EmailInboxInsightsSpamTraps::class => false];
    }
}
