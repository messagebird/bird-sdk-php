...
class WhatsAppInteractiveCardSendNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\WhatsAppInteractiveCardSend::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\WhatsAppInteractiveCardSend::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\WhatsAppInteractiveCardSend();
        ...
        if (\array_key_exists('header', $data) && $data['header'] !== null) {
            $object->setHeader($this->denormalizer->denormalize($data['header'], \MessageBird\Wire\Model\WhatsAppInteractiveCardSendHeader::class, 'json', $context));
        }
    ...
    {
        return [\MessageBird\Wire\Model\WhatsAppInteractiveCardSend::class => false];
    }
}
