...
class WhatsAppContactCardNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\WhatsAppContactCard::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\WhatsAppContactCard::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\WhatsAppContactCard();
        ...
        if (\array_key_exists('vcard', $data) && $data['vcard'] !== null) {
            $object->setVcard($data['vcard']);
        }
        elseif (\array_key_exists('vcard', $data) && $data['vcard'] === null) {
            $object->setVcard(null);
        }
        if (\array_key_exists('name', $data) && $data['name'] !== null) {
            $object->setName($this->denormalizer->denormalize($data['name'], \MessageBird\Wire\Model\WhatsAppContactCardName::class, 'json', $context));
        }
        elseif (\array_key_exists('name', $data) && $data['name'] === null) {
            $object->setName(null);
        }
        if (\array_key_exists('org', $data) && $data['org'] !== null) {
            $object->setOrg($this->denormalizer->denormalize($data['org'], \MessageBird\Wire\Model\WhatsAppContactCardOrg::class, 'json', $context));
        }
        ...
        if (\array_key_exists('phone_numbers', $data) && $data['phone_numbers'] !== null) {
            ...
            foreach ($data['phone_numbers'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \MessageBird\Wire\Model\WhatsAppContactPhone::class, 'json', $context);
            }
        ...
        if (\array_key_exists('emails', $data) && $data['emails'] !== null) {
            ...
            foreach ($data['emails'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \MessageBird\Wire\Model\WhatsAppContactEmail::class, 'json', $context);
            }
        ...
        if (\array_key_exists('urls', $data) && $data['urls'] !== null) {
            ...
            foreach ($data['urls'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \MessageBird\Wire\Model\WhatsAppContactUrl::class, 'json', $context);
            }
        ...
        if (\array_key_exists('addresses', $data) && $data['addresses'] !== null) {
            ...
            foreach ($data['addresses'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \MessageBird\Wire\Model\WhatsAppContactAddress::class, 'json', $context);
            }
    ...
    {
        return [\MessageBird\Wire\Model\WhatsAppContactCard::class => false];
    }
}
