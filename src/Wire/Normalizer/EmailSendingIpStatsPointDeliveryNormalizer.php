...
class EmailSendingIpStatsPointDeliveryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\EmailSendingIpStatsPointDelivery::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\EmailSendingIpStatsPointDelivery::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\EmailSendingIpStatsPointDelivery();
        ...
        if (\array_key_exists('bounces', $data) && $data['bounces'] !== null) {
            $object->setBounces($this->denormalizer->denormalize($data['bounces'], \MessageBird\Wire\Model\EmailSendingIpDeliveryStatsBounces::class, 'json', $context));
            unset($data['bounces']);
        }
    ...
    {
        return [\MessageBird\Wire\Model\EmailSendingIpStatsPointDelivery::class => false];
    }
}
