...
class WhatsAppStatsComparisonDeltaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \MessageBird\Wire\Model\WhatsAppStatsComparisonDelta::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \MessageBird\Wire\Model\WhatsAppStatsComparisonDelta::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \MessageBird\Wire\Model\WhatsAppStatsComparisonDelta();
        ...
        if (\array_key_exists('read_pct_change', $data) && \is_int($data['read_pct_change'])) {
            $data['read_pct_change'] = (float) $data['read_pct_change'];
        }
        ...
        if (\array_key_exists('read_rate_pp', $data) && \is_int($data['read_rate_pp'])) {
            $data['read_rate_pp'] = (float) $data['read_rate_pp'];
        }
    ...
    {
        return [\MessageBird\Wire\Model\WhatsAppStatsComparisonDelta::class => false];
    }
}
